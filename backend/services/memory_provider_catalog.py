        ...
        "modes": [
            {
                ...
                "dependencies": [],
                "setup_command": "Create a MemOS Cloud API key, then set MEMOS_API_KEY.",
                "status_command": "hermes memory status",
                "next_steps": "Set MEMOS_API_KEY, optionally set MEMOS_NAMESPACE, then run check status.",
            },
            {
                "id": "self_hosted",
                "label": "Self-hosted",
                ...
                "dependencies": [],
                "setup_command": "Start a MemOS API service, then set MEMOS_BASE_URL.",
                "status_command": "curl -sS $MEMOS_BASE_URL/health",
                "next_steps": "Set MEMOS_BASE_URL and run check status.",
            },
        ],
